...
- The text they carry is still content. Show me a PR title and body before the PR is created or updated, and a commit message before it is written, even though the publishing step itself is routine.
...
- Committing is local and needs no sign-off beyond the usual plan step. Pushing is routine but confirmed; comments on a PR or issue are strictly gated. See *Never post on my behalf without explicit approval*.
